 ...
 * @Package com.cache.redis
 * @Description: 
 * @Copyright: Copyright (c) 2016 广东心怡科技物流有限公司
 * 
 * @author gongdj
 * @date 2016年5月15日 下午11:07:42
 * @version V1.0
 */
...
//		
//		jedisPool = new JedisPool(config, "192.168.1.118", 6379);
		...
		jedisPool = new JedisPool(config, "192.168.1.110", 6379, 1000, "pwd");
	}
...
//		config.setTestOnBorrow(false);
		...
		shards.add(new JedisShardInfo("192.168.1.110", 6379, "master"));
